 ...
 */
export type ViewerDbTypes = (BulkInventoryItem | BasePallet | ParcelInventoryType | ParcelFlatBOM)[];
export type ViewerDbRowTypes = BulkInventoryItem | BasePallet | ParcelInventoryType | ParcelFlatBOM;